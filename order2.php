                           ...
                           <div class="row check_dostavka">
                               <div class="col-md-12 main_form">
                                   <div class="custom-control custom-radio">
                                       ...
                                       <label class="custom-control-label comfortaa" for="customRadio">Самовывоз</label>
                                   </div>
                                   <div class="custom-control custom-radio">
                                       <input type="radio" class="custom-control-input" id="customRadio2" name="example1" value="customEx">
                                       <label class="custom-control-label comfortaa" for="customRadio2">Доставка курьером</label>
                                   </div>
                                   <div class="custom-control custom-radio">
                                       <input type="radio" class="custom-control-input" id="customRadio3" name="example1" value="customEx">
                                       <label class="custom-control-label comfortaa" for="customRadio3">Доставка по городам РФ</label>
                                   </div>
                               </div>
                           </div>
                           <div class="row block_dostavka">
                               <div class="col-12">
                                   <div class="col-md-12 col-sm-8 next_step_wrap">
