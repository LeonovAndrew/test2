                    ...
                    <div class="col-lg-6">
                        <form class="main_form">
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Старый пароль" name="post_code" required>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Новый пароль" name="region" required>
                            </div>
