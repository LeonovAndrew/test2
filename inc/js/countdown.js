...
CountdownTimer.prototype={
 initialize:function(elm,tl,mes) {
  ...
  if( ( this.tl - today ) > 0 ){
   ...
   timer += '<span class="number-wrapper"><div class="line"></div><div class="caption">Мунуты</div><span class="number min">'+this.addZero(min)+' : </span></span>' +
       '<span class="number-wrapper"><div class="line"></div><div class="caption">Секунды</div><span class="number sec">'+this.addZero(sec)+'</span></span>';
...
function CDT(tl){
 ...
 // Set countdown limit
 //var tl = new Date('2019/03/21 00:00:00');
